...
/***************** Livres *****************/
insert into public.livres (bibliotheque_id, titre, auteur, isbn, date_ajout, disponible) values
(1, 'Walking dead. 32, La fin du voyage', 'Robert Kirkman', '9782413016816', '2019-01-01', true),
(1, 'Raconte-moi Marc-André Fleury', 'Frédéric Daigle', '9782897541675', '2019-02-15', false),
(2, 'Raconte-moi Carey Price', 'Jean-François Chaumont', '9782924025949', '2015-03-05', true),
...
(2, 'Jean Dupont', '2024-05-01'),
(4, 'Marie Tremblay', '2024-05-10');
